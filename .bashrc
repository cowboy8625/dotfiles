...
function play_ambiences() {
    if [ "thunder1" == $1 ]; then
        echo "Thunder Storm One" $1;
        mpv --loop "./Music/AmbientSounds/thunder-storm-1.mp3";
    elif [ "thunder2" == $1 ]; then
        echo "Thunder Storm Two" $1;
        mpv --loop "./Music/AmbientSounds/thunder-storm-2.mp3";
    elif [ "thunder3" == $1 ]; then
        echo "Thunder Storm Two" $1;
